...
params.nTarg = 5;               % Number targets
params.detectionDist = 0.05;     % Target detection distance

params.nObs = 10;                % Number obstacles
params.obsRadius = 0.15;        % Obstacle avoidance radius
